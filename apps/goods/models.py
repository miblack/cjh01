...
class IndexTypeGoodsBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE_CHOICES, verbose_name='图片展示类型')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
...
class IndexPromotionBanner(BaseModel):
    ...
    idnex = models.SmallIntegerField(default=0, verbose_name='展示顺序')
